// Firebase is initialized in the layout via window.fbConfig (injected by server).
// Initialize auth/db lazily when firebase is available.
let auth, db;
...
// Try to initialize firebase-related objects immediately (layout loads firebase before this script)
ensureFirebase();
